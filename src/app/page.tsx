...
const shortcuts = [
  ...
  },
  {
    id: 'a2',
    title: 'Best Apps',
    description: 'Curated best iPhone apps',
    url: 'https://apps.apple.com/us/story/id2020',
    icon: '⭐',
  ...
  },
  {
    ...
    url: 'https://departuresapp.com',
    icon: '✈️',
    color: 'bg-gradient-to-br from-sky-400 to-blue-600',
  },
  {
    id: 't2',
    title: 'Best TestFlight App',
    description: 'Discover beta apps',
    url: 'https://testflight.app',
    icon: '🧪',
    color: 'bg-gradient-to-br from-amber-400 to-yellow-600',
  },
  {
    id: 't3',
    title: 'TestFlight Public Links',
    description: 'Public TestFlight betas',
    url: 'https://testflightqr.com',
    icon: '🔗',
